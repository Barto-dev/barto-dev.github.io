...
const createTripCostTemplate = () => {
  return (
    `<section class="trip-main__trip-info  trip-info">
       <p class="trip-info__cost">Total: &euro;&nbsp;<span class="trip-info__cost-value">${_computed__WEBPACK_IMPORTED_MODULE_1__["allPointPrice"]}</span></p>
     </section>`
  );
};
...
/*!*************************!*\
  !*** ./src/computed.js ***!
  \*************************/
/*! exports provided: travelPointAll, allPointInfo, allPointPrice, travelPoints, travelDays */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "travelPointAll", function() { return travelPointAll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allPointInfo", function() { return allPointInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allPointPrice", function() { return allPointPrice; });
...
const travelPointAll = new Array(_constants__WEBPACK_IMPORTED_MODULE_2__["EVENT_DAY"])
  .fill(undefined)
  .map(_mock_travel__WEBPACK_IMPORTED_MODULE_0__["travelPoint"])
  .sort((a, b) => {
    return a.day - b.day;
  });
...
const allPointPrice = allPointInfo
  .map((item) => {
 ...
 * @return {string}
 */
const getMomentTimeAsString = (inputMoment) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(inputMoment).format(`HH:mm`);
};
 ...
 * @return {string}
 */
const getMomentDaysAsString = (inputMoment) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(inputMoment).format(`DD`);
};
 ...
 * @return {string}
 */
const getMomentMonthAsString = (inputMoment) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(inputMoment).format(`MMM DD`);
};
 ...
 * @return {string}
 */
const getMomentISOFormat = (inputMoment) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(inputMoment).toISOString();
};
 ...
 * @return {string}
 */
const getMomentSlashedFormat = (inputMoment) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(inputMoment).format(`YY/MM/DD HH:mm`);
};
 ...
 * @return {string}
 */
const getTimeBetween = (startMoment, endMoment) => {
  const day = moment__WEBPACK_IMPORTED_MODULE_0___default()(endMoment).diff(startMoment, `days`);
  const hour = moment__WEBPACK_IMPORTED_MODULE_0___default()(endMoment).diff(startMoment, `hours`) % 24;
  const minute = moment__WEBPACK_IMPORTED_MODULE_0___default()(endMoment).diff(startMoment, `minute`) % 60;
  let gapString = ``;
  if (day > 0) {
